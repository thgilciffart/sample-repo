...
static const char *applaunch[] = { "rofi", "-show", "drun", NULL };
static const char *fileopen[] = { "rofi", "-show", "recursivebrowser", NULL };
static const char *pdf[]  = { "pdf-search.sh", NULL };
static const char *power[]  = { "power-menu.sh", NULL };
static const char *theme[]  = { "theme-selector.sh", NULL };
static const char *termcmd[]  = { "alacritty", NULL };
static const char *maim[]  = { "screenshot.sh", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_d,          spawn,                  {.v = applaunch } },
	{ MODKEY,                       XK_p,          spawn,                  {.v = pdf } },
	{ MODKEY|ShiftMask,             XK_p,          spawn,                  {.v = fileopen } },
	{ MODKEY,                       XK_t,          spawn,                  {.v = theme } },
	{ MODKEY|ShiftMask,             XK_Delete,     spawn,                  {.v = power } },
	{ 0,                            XF86XK_PowerOff, spawn,                {.v = power } },
	{ MODKEY,                       XK_Return,     spawn,                  {.v = termcmd } },
	{ 0,                            XK_Print,      spawn,                  {.v = maim } },
	{ MODKEY,                       XK_v,	       spawn,                  {.v = clipcat } },
	{ MODKEY|ShiftMask,             XK_c,          spawn,        SHCMD("magick import -window root /tmp/screen.png && magick /tmp/screen.png -resize 1x1! -format '#%[hex:u]' info: | xclip -selection clipboard") },
	{ 0,                            XF86XK_AudioRaiseVolume, spawn,        SHCMD("volume_control.sh up") },
	{ 0,                            XF86XK_AudioLowerVolume, spawn,        SHCMD("volume_control.sh down") },
	{ 0,                            XF86XK_AudioMute, spawn,               SHCMD("volume_control.sh mute") },
	{ 0,                            XF86XK_MonBrightnessUp, spawn,         SHCMD("brightness_control.sh up") },
	{ 0,                            XF86XK_MonBrightnessDown, spawn,       SHCMD("brightness_control.sh down") },
